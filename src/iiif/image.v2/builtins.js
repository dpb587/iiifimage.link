...
const builtinFeatures = [
  ...
  },
  {
    name: 'mirroring',
    category: 'Rotation',
    description: 'The image may be rotated around the vertical axis, resulting in a left-to-right mirroring of the content.',
    requiredLevels: [],
  },
  {
  ...
  },
  {
    name: 'regionSquare',
    category: 'Region',
    description: 'A square region where the width and height are equal to the shorter dimension of the complete image content.',
    requiredLevels: [],
  },
  {
  ...
  },
  {
    name: 'sizeByWh',
    category: 'Size',
    description: 'Size of images may be requested in the form “w,h” where the supplied w and h preserve the aspect ratio.',
    requiredLevels: [
      'level2',
    ],
  },
