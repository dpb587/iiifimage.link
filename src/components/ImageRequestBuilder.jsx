  ...
  return (
    <section className="my-4">
      <div className="px-4">
        <div className="rounded-md border border-neutral-300 bg-white shadow-sm">
          <div className="relative flex">
            ...
            <div className="flex w-full pl-9 pr-20 text-neutral-800">
              ...
              <button
                className="group relative p-2 tracking-wide"
                title="{region}"
                onClick={() =>
              ...
              >
                ...
                <div
                  className={clsx(
                    "-tranneutral-x-px absolute inset-x-0.5 bottom-1 h-0.5 rounded-full transition duration-100",
            ...
            <div className="absolute inset-y-1.5 right-1.5 -mr-px flex items-center space-x-1.5">
              <button
                type="button"
        ...
        {errors.length > 0 && (
          <div className="-mt-1 rounded-b-md border border-t-2 border-red-900 bg-neutral-50 text-sm font-medium shadow">
